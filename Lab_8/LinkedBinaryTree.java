...
public class LinkedBinaryTree<T> implements BinaryTreeADT<T>
{
   ...
   *****************************************************************/
   public Iterator<T> iteratorLevelOrder() 
   {
     ...
     while (!nodes.isEmpty())
     {
         BinaryTreeNode<T> n = (BinaryTreeNode<T>) nodes.poll();
         if (n != null)
         {
             results.offer(n.getElement());
             nodes.offer(n.getLeftChild());
             nodes.offer(n.getRightChild());
         }   
         else
         {
             results.offer(null);
   ...
   public void rotateRight()
   {
       ...
       BinaryTreeNode<T> sub;
       
       root = root.getLeftChild();  // Step A. (New Root)...
       sub = root.getRightChild();  // Step C_1.
       
       root.setRightChild(n);       // Step B.
       n.setLeftChild(sub);         // Step C_2.
   }
