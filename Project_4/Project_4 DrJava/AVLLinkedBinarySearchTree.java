   ...
   ******************************************************************/
   public void addElement (T element) 
   {
      ...
      else 
      {
         ...
         while (!added) 
         {
            if (element.compareTo(current.element) < 0) // less.
            {
               if (current.left == null) 
               {
                  current.left = node;  // add the node
                  node.parent = current;
                  added = true;
               } 
               else
            ...
            else // same or greater.
            {
               ...
               {
                  current.right = node; // add the node.
                  node.parent = current;
                  added = true;
               } 
               else
   ...
   private boolean rebalance(AVLBinarySearchTreeNode<T> node)
   {
     ...
     {
         if (node.left.balanceFactor == -1 || node.left.balanceFactor == 0)
         {
     ...
     {
         if (node.right.balanceFactor == 1 || node.right.balanceFactor == 0)
         {
   ...
   private void rotateLeft(AVLBinarySearchTreeNode<T> pivot)
   {
     ...
     // TODO: add your code here
     newPivot.balanceFactor = (treeHeight(newPivot.right) - (treeHeight(newPivot.left)));
     pivot.balanceFactor = (treeHeight(pivot.right) - (treeHeight(pivot.left)));
  }
  
  private int treeHeight(AVLBinarySearchTreeNode<T> node)
  {
      if (node == null)
          return 0;
      else
