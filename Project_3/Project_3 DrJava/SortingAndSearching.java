...
public class SortingAndSearching<T extends Comparable<T>>  
{
   ...
   ********************************************************************/
   private int findPartition (T[] data, int min, int max)
   {
      ...
      // swap data[min] and data[mid] element after setting data[mid] as the partition element.
      partitionelement = data[mid];
      temp = data[mid];
      data[mid] = data[min];
      data[min] = temp;
   ...
   ********************************************************************/
   public void bubbleSort (T[] data)
   {
      int position, scan;
      T temp;
      // inner loop keeps track of if a swap is made 
      //and the outer loop terminates if the inner loop makes no swaps.
